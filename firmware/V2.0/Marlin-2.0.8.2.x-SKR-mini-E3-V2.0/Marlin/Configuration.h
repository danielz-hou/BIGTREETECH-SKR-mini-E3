...
#define CONFIG_EXAMPLES_DIR "LulzbotMini/BigTreeTech SKR Mini E3 2.0"
...
#define STRING_CONFIG_H_AUTHOR "(Daniel Zhou, LulzbotMini)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LulzbotMini"
